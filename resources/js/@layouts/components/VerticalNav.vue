      ...
      <slot name="nav-header">
        ...
        >
          <VNodeRenderer 
            ...
            :nodes="global.current.value.dark ? themeConfig.app.logoIconLight : themeConfig.app.logoIconDark" 
          />
          <VNodeRenderer 
            v-else
            :nodes="global.current.value.dark ? themeConfig.app.logo : themeConfig.app.logoDark" 
          />
    ...
    <div class="nav-wrapper">
      ...
      >
        <PerfectScrollbar
          ...
          tag="ul"
          class="nav-items hide-vertical-scrollbar"
